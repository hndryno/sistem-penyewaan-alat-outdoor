...
<div class="page-header">
    <h3 class="page-title"> Ubah Data Admin </h3>
</div>
<div class="row">
    <div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
        <form class="forms-sample" action="{{route('manajemenadmin.update',$admin->id)}}" method="POST" id="ubah-form-{{$admin->id}}">
        @csrf
        {{method_field('PUT')}}
            <div class="row">
                <div class="col-md-6">
            ...
            <button type="button" class="btn btn-sm btn-outline-danger btn-icon-text" onclick="ubahPassword({{$admin->id}})">Ubah Password</button>
